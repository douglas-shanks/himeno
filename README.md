# himeno OpenMP and OpenACC GPU offloading
...
To setup a different model one can change the header file by using the provided script paramset.sh e.g XL model with a decomposition of 2x2x1 `bash paramset.sh XL 2 2 1`
